...
pwd
LASTCOMP=`ls -1t ./fmippn-distribution/fmippn-testdata/*_fmi.radar.composite.lowest_FIN_RAVAKE.pgm | head -1`
...
$HOME/miniconda3/envs/fmippn/bin/python run_ppn.py --timestamp=${TIMESTAMP} --config=docker_ravake # >> $OPER/esteri_realtime_ppn.log 2>&1
date
popd
